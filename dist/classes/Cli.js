...
class Cli {
    ...
    createMotorbike() {
        inquirer
            ...
            const motorbike = new Motorbike(Cli.generateVin(), answers.color, answers.make, answers.model, parseInt(answers.year), parseInt(answers.weight), parseInt(answers.topSpeed), [], parseInt(answers.frontWheelDiameter), answers.rearWheelBrand, parseInt(answers.rearWheelDiameter), answers.frontWheelBrand);
